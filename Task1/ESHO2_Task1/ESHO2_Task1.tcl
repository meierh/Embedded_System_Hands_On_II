...
#
# ESHO2_Task1.tcl: Tcl script for re-creating project 'ESHO2_Task1'
#
# Generated by Vivado on Wed Jan 03 10:14:37 CET 2024
...
#
# 1. This project restoration tcl script (ESHO2_Task1.tcl) that was generated.
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set paths [list \
 "[file normalize "$origin_dir/../../../../../../../../../home/helge/MysteryRegs"]"]"\
  ]
  foreach ipath $paths {
...
set _xil_proj_name_ "ESHO2_Task1"
...
set script_file "ESHO2_Task1.tcl"
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../MysteryRegs"]" $obj
...
set_property -name "top" -value "system_task1_wrapper" -objects $obj
...
# Proc to create BD system_task1
proc cr_bd_system_task1 { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name system_task1
  ...
  if { $bCheckIPs == 1 } {
     set list_check_ips "\ 
  esa.informatik.tu-darmstadt.de:user:MysteryRegs:1.0\
  ...
  # Create instance: MysteryRegs_0, and set properties
  set MysteryRegs_0 [ create_bd_cell -type ip -vlnv esa.informatik.tu-darmstadt.de:user:MysteryRegs:1.0 MysteryRegs_0 ]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins MysteryRegs_0/S_AXI]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins MysteryRegs_0/S_AXI_aclk] [get_bd_pins axi_interconnect_0/M00_ACLK]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins MysteryRegs_0/S_AXI_aresetn]
  ...
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs MysteryRegs_0/S_AXI/reg0] -force
...
# End of cr_bd_system_task1()

cr_bd_system_task1 ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files system_task1.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files system_task1.bd ] 
set_property IS_ENABLED "1" [get_files system_task1.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files system_task1.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files system_task1.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files system_task1.bd ] 
set_property PFM_NAME "" [get_files system_task1.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files system_task1.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files system_task1.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files system_task1.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files system_task1.bd ] 
set_property USED_IN_SIMULATION "1" [get_files system_task1.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files system_task1.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list system_task1.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/ESHO2_Task1.gen/sources_1/bd/system_task1/hdl/system_task1_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list system_task1.bd]] -top]
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/ESHO2_Task1.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/ESHO2_Task1.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/ESHO2_Task1.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
