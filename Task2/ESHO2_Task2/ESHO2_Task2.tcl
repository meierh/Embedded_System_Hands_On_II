...
#
# ESHO2_Task2.tcl: Tcl script for re-creating project 'ESHO2_Task2'
#
# Generated by Vivado on Wed Jan 03 10:20:30 CET 2024
...
#
# 1. This project restoration tcl script (ESHO2_Task2.tcl) that was generated.
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set paths [list \
 "[file normalize "$origin_dir/../../../../../../../../../home/helge/Adder"]"]"\
  ]
  foreach ipath $paths {
...
set _xil_proj_name_ "ESHO2_Task2"
...
set script_file "ESHO2_Task2.tcl"
...
set_property -name "board_part_repo_paths" -value "[file normalize "$origin_dir/../../../../../../../../../home/helge/.Xilinx/Vivado/2023.2/xhub/board_store/xilinx_board_store"]" -objects $obj
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../Adder"]" $obj
...
set_property -name "top" -value "system_task2_wrapper" -objects $obj
...
# Proc to create BD system_task2
proc cr_bd_system_task2 { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name system_task2
  ...
  esa.informatik.tu-darmstadt.de:user:Adder:1.0\
  ...
  set Adder_0 [ create_bd_cell -type ip -vlnv esa.informatik.tu-darmstadt.de:user:Adder:1.0 Adder_0 ]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins Adder_0/AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_interconnect_0_M00_AXI] [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins system_ila_0/SLOT_0_AXI]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins Adder_0/CLK] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins debug_bridge_0/s_axi_aclk] [get_bd_pins debug_bridge_1/clk] [get_bd_pins axi_interconnect_0/M01_ACLK]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins Adder_0/RST_N] [get_bd_pins system_ila_0/resetn] [get_bd_pins debug_bridge_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/M01_ARESETN]
  ...
  assign_bd_address -offset 0xA0000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs Adder_0/AXI/reg0] -force
...
# End of cr_bd_system_task2()

cr_bd_system_task2 ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files system_task2.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files system_task2.bd ] 
set_property IS_ENABLED "1" [get_files system_task2.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files system_task2.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files system_task2.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files system_task2.bd ] 
set_property PFM_NAME "" [get_files system_task2.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files system_task2.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files system_task2.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files system_task2.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files system_task2.bd ] 
set_property USED_IN_SIMULATION "1" [get_files system_task2.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files system_task2.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list system_task2.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/ESHO2_Task2.gen/sources_1/bd/system_task2/hdl/system_task2_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list system_task2.bd]] -top]
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/ESHO2_Task2.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/ESHO2_Task2.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/ESHO2_Task2.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
